...
class AdminCog(commands.Cog):
    ...
    @app_commands.command(name="admin", description="Открыть панель управления ботом")
    ...
    @app_commands.command(name="tickets", description="Показать список открытых заявок")
    @app_commands.guild_only()
    ...
    @app_commands.command(name="sync", description="Синхронизировать slash-команды (только для владельца)")
    @app_commands.guild_only()
